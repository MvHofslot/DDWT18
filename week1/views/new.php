    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <!-- Left column -->
                <form class="col-md-8" method="post" action=<?= $form_action?>>
                    <!-- Error message -->
                    ...
                    <!-- Put your form here -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="inputAbstract" rows="3" name="Abstract">What is this series about?</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-10">
